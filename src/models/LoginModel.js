...
class Login {
    ...
    async userExists() {
        this.user = await LoginModel.findOne({ email: this.body.email });//user recebe o email que está no banco de dados, se esse for igual ao que ele colocou no input email
